...
Example: let's say you find all the positions and group them all together. Some of these groups will be different than zero, some of them will not. It seems like on should `force' the ones that are not different from zero, to actually be zero. Then sweep through the z-score matching again to see if things further reduce.

Now you go to the the velocity stage where you divided the knot points. 
