...
I'm now weighting by data density, so that we don't get knot points in regions of no data. One could also weight by data quality, as determined by the error in the previous iteration. I think this is necessary because the spline technique needs a way of `rejecting' bad data points.
