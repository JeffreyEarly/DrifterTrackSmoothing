...
\[
\rho_t(\epsilon_i) = - \log \left( \frac{2 \sqrt{2}}{\sqrt{3 \pi}} \left( 1 + \frac{\epsilon_i^2}{2 \sigma_i^2} \right)^{-2} \right)
\]
and 
\[
\psi_t(\epsilon_i) = \frac{ 4 \epsilon_i}{3 \sigma_i^2} \left( 1 + \frac{\epsilon_i^2}{3 \sigma_i^2} \right)^{-1}.
\]
...
=& \frac{4}{3} \sigma_i^2  \left( 1 + \frac{\epsilon_i^2}{3 \sigma_i^2} \right)
\end{align}
