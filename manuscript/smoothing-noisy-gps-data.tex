...
For this method to work, one must estimate the root-mean-square velocity, $u_{\textrm{rms}$, of the signal in order to determine the effective degrees of freedom, as well as variance of tensioned derivative, $a_{\textrm{std}^2$, for example. 
